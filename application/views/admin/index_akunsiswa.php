		...
		<div class="col s12 m5">
          <div class="card">
			<div class="card-image">
			 <a href="<?php echo base_url('admin/user_siswa/akunsiswa_belumdaftar/');?>" class="waves-effect waves-light">
              <img src="<?php echo base_url();?>assets/images/background.jpg">
			  <span class="card-title">Akun Siswa Belum Terdaftar</span>
			 </a>
			</div>
			...
			<div class="card-reveal">
			  ...
			  <b> Data Akun Siswa yang Belum Terdaftar </b>
			  <p> agar siswa dapat login atau memiliki akun di aplikasi Portal Student.</p>
			  <p> hanya Admin yang bisa membuat username dan juga password. </p>
			  <p> buatlah akun siswa sesuai dengan Nama atau NIS Siswa tersebut. </p>
			</div>
		  </div>
        </div>
...
<!--Sudah Terdaftar--> 
		<div class="col s12 m5 right">
          <div class="card">
			<div class="card-image">
			 <a href="<?php echo base_url('admin/user_siswa/akunsiswa_sudahdaftar/');?>" class="waves-effect waves-light">
              <img src="<?php echo base_url();?>assets/images/background.jpg">
			  <span class="card-title">Akun Siswa Sudah Terdaftar</span>
			 </a>
			</div>
			<div class="card-content">
			  <span class="card-title activator grey-text text-darken-4">Info<i class="material-icons right">keyboard_arrow_right</i></span>
			...
			<div class="card-reveal">
			  <span class="card-title grey-text text-darken-4">Info<i class="material-icons right">close</i></span>
			  <b> Data Akun Siswa yang Sudah Terdaftar </b>
			  <p> Siswa disini sudah terdaftar di aplikasi Portal Student.</p>
