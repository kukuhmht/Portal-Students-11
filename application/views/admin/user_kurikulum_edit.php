...
<head>
  ...
  <title>Edit Akun Kurikulum</title>
...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('admin/user_kurikulum');?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i>Edit Akun Kurikulum</a>
		<a href="<?php echo base_url('admin/user_kurikulum');?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i>Edit Akun Kurikulum</a>
	  </div>
	</nav>
</div>
<!--end header-->
...
<br>
<div class="container">
<?php echo form_open('admin/user_kurikulum/update_akunkurikulum/'.$ID); ?>
<div class="row card">
  <div class="col s12">
  <br/>
  <br/>
	<input hidden id="hak_akses" name="hak_akses" value="kurikulum" type="text">
