...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('admin/user_siswa/edit/'.$namakelas.'/'.$idkelas);?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i><?php echo $title ?> <?php echo $namakelas ?></a>
		<a href="<?php echo base_url('siswa/user_siswa/edit/'.$namakelas.'/'.$idkelas);?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i><?php echo $title ?> <?php echo $namakelas ?></a>
	  </div>
	</nav>
</div>
<!--end header-->
...
<div class="row">
	...
	<div class="col s6">
		...
		<p> <b> Nomor Telepon: </b> <?php echo $nomor_hp ?> </p>
	</div>
	</div>
</div>
<?php echo form_open( 'admin/user_siswa/tambah_usersiswa/'.$namakelas.'/'.$idkelas.'/'.$ID); ?>
<div class="row card">
  <div class="col s12">
  <br/>
  <br/>
	<input hidden id="username" name="username" value="<?php echo $nama_siswa ?>" type="text">
	<input hidden id="hak_akses" name="hak_akses" value="siswa" type="text">
	...
	<div class="input-field col s12 m6">
	  <input id="no_identitas" name="no_identitas" placeholder="buat username sesuai dengan Nama Siswa: <?php echo $nama_siswa ?>" type="text" class="validate">
