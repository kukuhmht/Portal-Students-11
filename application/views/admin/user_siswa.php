...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('admin/user_siswa');?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i><?php echo $title ?> <?php echo $namakelas ?></a>
		<a href="<?php echo base_url('admin/user_siswa');?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i><?php echo $title ?> <?php echo $namakelas ?></a>
	  </div>
	</nav>
</div>
<!--end Header-->
		...
		<div class="col s12 m4">
          <div class="card">
			<div class="card-image">
			 <a href="<?php echo base_url('admin/user_siswa/edit/'.$row->nama_kelas.'/'.$row->ID);?>" class="waves-effect waves-light">
