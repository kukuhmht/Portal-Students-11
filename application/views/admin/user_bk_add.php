...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('admin/user_bk');?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i><?php echo $title ?></a>
		<a href="<?php echo base_url('admin/user_bk');?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i><?php echo $title ?></a>
	  </div>
	</nav>
</div>
<!--end header-->
...
<br>
<div class="container">
<?php echo form_open('admin/user_bk/add_akunbk'); ?>
<div class="row card">
  <div class="col s12">
  <br/>
  <br/>
