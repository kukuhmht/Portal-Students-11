...
<head>
  ...
  <title>Edit Akun Kesiswaan</title>
...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('admin/user_kesiswaan');?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i>Edit Akun Kesiswaan</a>
		<a href="<?php echo base_url('admin/user_kesiswaan');?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i>Edit Akun Kesiswaan</a>
	  </div>
	</nav>
</div>
<!--end header-->
...
<br>
<div class="container">
<?php echo form_open('admin/user_kesiswaan/update_akunkesiswaan/'.$ID); ?>
<div class="row card">
  <div class="col s12">
  <br/>
  <br/>
	<input hidden id="hak_akses" name="hak_akses" value="kesiswaan" type="text">
