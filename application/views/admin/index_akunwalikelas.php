		...
		<div class="col s12 m5">
          <div class="card">
			<div class="card-image">
			 <a href="<?php echo base_url('admin/user_walikelas/belum_akunwalikelas/');?>" class="waves-effect waves-light">
              <img src="<?php echo base_url();?>assets/images/background.jpg">
			  <span class="card-title">Akun Wali Kelas Belum Terdaftar</span>
			 </a>
			</div>
			...
			<div class="card-reveal">
			  ...
			  <b> Data Akun Wali Kelas yang Belum Terdaftar </b>
			  <p> agar Wali Kelas dapat login atau memiliki akun di aplikasi Portal Student.</p>
			  <p> hanya Admin yang bisa membuat username dan juga password. </p>
			  <p> buatlah akun Wali Kelas sesuai dengan Nama atau NIP Guru tersebut. </p>
			</div>
		  </div>
        </div>
...
<!--Sudah Terdaftar--> 
		<div class="col s12 m5 right">
          <div class="card">
			<div class="card-image">
			 <a href="<?php echo base_url('admin/user_walikelas/sudah_akunwalikelas/');?>" class="waves-effect waves-light">
              <img src="<?php echo base_url();?>assets/images/background.jpg">
			  <span class="card-title">Akun Wali Kelas Sudah Terdaftar</span>
			 </a>
			</div>
			<div class="card-content">
			  <span class="card-title activator grey-text text-darken-4">Info<i class="material-icons right">keyboard_arrow_right</i></span>
			...
			<div class="card-reveal">
			  <span class="card-title grey-text text-darken-4">Info<i class="material-icons right">close</i></span>
			  <b> Data Akun Wali Kelas yang Sudah Terdaftar </b>
			  <p> Wali Kelas disini sudah terdaftar di aplikasi Portal Student.</p>
