...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('admin/user');?>" class="brand-logo hide-on-med-and-down">&nbsp; <?php echo $title ?> </a>
		<a href="<?php echo base_url('admin/user');?>" class="hide-on-med-and-up">&nbsp; <?php echo $title ?> </a>
	  </div>
	</nav>
</div>
<!--end Header-->
