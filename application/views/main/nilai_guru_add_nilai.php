...
<head>
  ...
  <title>Edit Nilai Siswa Kelas <?php echo $namakelas ?></title>
...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('nilai_guru/edit/'.$namakelas.'/'.$idkelas);?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i> Edit Nilai Siswa Kelas <?php echo $namakelas ?></a>
		<a href="<?php echo base_url('nilai_guru/edit/'.$namakelas.'/'.$idkelas);?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i> Edit Nilai Siswa Kelas <?php echo $namakelas ?></a>
	  </div>
	</nav>
</div>
<!--end Header-->
				...
				<table>
					...
					<tbody>
					  <tr>
						...
						<td> <a href="<?php echo base_url('nilai_guru/edit_nilai/'.$namakelas."/".$idkelas."/".$id_siswa."/".$row->ID."/".$row->semester); ?>"><i class="material-icons">edit</i></a> </td>
						<td> <a href="<?php echo base_url('nilai_guru/hapus_nilai/'.$namakelas."/".$idkelas."/".$id_siswa."/".$row->ID); ?>" onclick="return confirm('Apakah anda yakin ingin menghapus ?')"><i class="material-icons">delete</i></a> </td>
					  </tr>
					<?php }?>
					<?php if(count($nilai_siswa_uts1) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UTS Semester 1</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					</tbody>
					<form action="<?php echo base_url(). 'nilai_guru/tambah_nilai'; ?>" method="post">
					<tbody>
						<tr>
						<td>
							...
							<input hidden type="text" id="semester" name="semester" value="1" />
							<input hidden type="text" id="ujian" name="ujian" value="uts" />
						</td>
						<td>
							<div class="input-field">
								<input type="text" id="mapel" name="mapel" />
								<label> Masukan Matapelajaran </label>
							</div>
						</td>
						<td>
							<div class="input-field">
								<input type="text" id="pengetahuan" name="pengetahuan" />
								<label> Masukan Nilai Pengetahuan </label>
							</div>
						</td>
						<td>
							<div class="input-field">
								<input type="text" id="keterampilan" name="keterampilan" />
								<label> Masukan Keterampilan </label>
							</div>
						</td>
						<td colspan='2'>
							<div class="input-field">
								<button class="waves-effect waves-light btn" type="submit" value="simpan" name="simpan">
								Simpan
								</button>
							</div>
						</td>
			...
			<div id="uas1" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uas1) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UAS Semester 1</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					...
					<tbody>
						...
						<td>
							...
							<input hidden type="text" id="kode_kelas" name="kode_kelas" value="<?php echo $idkelas ?>" />
							<input hidden type="text" id="semester" name="semester" value="1" />
							<input hidden type="text" id="ujian" name="ujian" value="uas" />
						</td>
						<td>
							<div class="input-field">
								<input type="text" id="mapel" name="mapel" />
			...
			<div id="uts2" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uts2) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UTS Semester 2</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					...
					<tbody>
						...
						<td>
							...
							<input hidden type="text" id="id_siswa" name="id_siswa" value="<?php echo $id_siswa ?>" />
							<input hidden type="text" id="kode_kelas" name="kode_kelas" value="<?php echo $idkelas ?>" />
							<input hidden type="text" id="semester" name="semester" value="2" />
							<input hidden type="text" id="ujian" name="ujian" value="uts" />
						</td>
						<td>
							<div class="input-field">
			...
			<div id="uas2" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uas2) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UAS Semester 2</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
			...
			<div id="uts3" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uts3) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UTS Semester 3</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					...
					<tbody>
						...
						<td>
							...
							<input hidden type="text" id="id_siswa" name="id_siswa" value="<?php echo $id_siswa ?>" />
							<input hidden type="text" id="kode_kelas" name="kode_kelas" value="<?php echo $idkelas ?>" />
							<input hidden type="text" id="semester" name="semester" value="3" />
							<input hidden type="text" id="ujian" name="ujian" value="uts" />
						</td>
						<td>
							<div class="input-field">
			...
			<div id="uas3" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uas3) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UAS Semester 3</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
			...
			<div id="uts4" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uts4) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UTS Semester 4</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					...
					<tbody>
						...
						<td>
							...
							<input hidden type="text" id="id_siswa" name="id_siswa" value="<?php echo $id_siswa ?>" />
							<input hidden type="text" id="kode_kelas" name="kode_kelas" value="<?php echo $idkelas ?>" />
							<input hidden type="text" id="semester" name="semester" value="4" />
							<input hidden type="text" id="ujian" name="ujian" value="uts" />
						</td>
						<td>
							<div class="input-field">
			...
			<div id="uas4" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uas4) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UAS Semester 4</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
			...
			<div id="uts5" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uts5) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UTS Semester 5</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					...
					<tbody>
						...
						<td>
							...
							<input hidden type="text" id="id_siswa" name="id_siswa" value="<?php echo $id_siswa ?>" />
							<input hidden type="text" id="kode_kelas" name="kode_kelas" value="<?php echo $idkelas ?>" />
							<input hidden type="text" id="semester" name="semester" value="5" />
							<input hidden type="text" id="ujian" name="ujian" value="uts" />
						</td>
						<td>
							<div class="input-field">
			...
			<div id="uas5" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uas5) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UAS Semester 5</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
			...
			<div id="uts1" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uts6) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UTS Semester 6</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
					...
					<tbody>
						...
						<td>
							...
							<input hidden type="text" id="id_siswa" name="id_siswa" value="<?php echo $id_siswa ?>" />
							<input hidden type="text" id="kode_kelas" name="kode_kelas" value="<?php echo $idkelas ?>" />
							<input hidden type="text" id="semester" name="semester" value="6" />
							<input hidden type="text" id="ujian" name="ujian" value="uts" />
						</td>
						<td>
							<div class="input-field">
			...
			<div id="uas6" class="col s12">
				<table>
					...
					<?php if(count($nilai_siswa_uas6) == 0) { ?>
					  <tr>
						<td colspan="5" class="center">
							<b>Siswa ini Belum Memiliki Nilai UAS Semester 6</b> <br>
							Tambahkan Nilai dengan mengisikan form di bawah ini.
						</td>
					  </tr>
					<?php } ?>
