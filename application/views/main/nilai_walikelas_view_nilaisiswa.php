...
<div class="navbar-fixed">
	<nav class="z-depth-2">
	  <div class="nav-wrapper green lighten-1">
		<a href="<?php echo base_url('nilai_walikelas/edit/'.$namakelas.'/'.$idkelas);?>" class="brand-logo hide-on-med-and-down">&nbsp; <i class="material-icons">arrow_back</i> Data Nilai Siswa Kelas <?php echo $namakelas ?></a>
		<a href="<?php echo base_url('nilai_walikelas/edit/'.$namakelas.'/'.$idkelas);?>" class="hide-on-med-and-up">&nbsp; <i class="material-icons">arrow_back</i> Data Nilai Siswa Kelas <?php echo $namakelas ?></a>
	  </div>
	</nav>
</div>
<!--end Header-->
