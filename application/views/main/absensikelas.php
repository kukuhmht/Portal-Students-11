...
<!--end Desember-->
	...
	<div class="fixed-action-btn">
		<a href="<?php echo base_url('absensikelas_add'); ?>" class="modal-trigger btn-floating btn-large tooltipped waves-effect waves-light green" data-position="left" data-delay="50" data-tooltip="Input Data Absensi Hari Ini">
		  <i class="large material-icons">add</i>
		</a>
	</div>
	<!--end Button Tambah Data Absensi-->
