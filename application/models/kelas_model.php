...
class Kelas_model extends CI_Model {
	...
	public function data_walikelas() {
		return $this->db->query('SELECT nama_guru FROM guru ORDER BY nama_guru;');
	}
	...
	// Tambah Data Siswa ke table siswa
	public function tambah_siswa($table, $data) {
		$hasil = $this->db->insert($table,$data);
		return $hasil;
	}
	
	// Tambah Data Siswa ke table temp_daftarsiswa
	public function tambah_tempsiswa($table, $data) {
		$hasil = $this->db->insert($table,$data);
		return $hasil;
	}
